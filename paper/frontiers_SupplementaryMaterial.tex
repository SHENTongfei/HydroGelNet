...
\midrule
\textbf{SIMPLEX} & \textbf{0.69} & \textbf{0.87} & \textbf{0.94} & \textbf{1.00} & \textbf{0.90} \\
SVR-RBF & 0.63 & 0.85 & 0.94 & 1.00 & 0.90 \\
...
generalisation gap ($0.79 \rightarrow 0.69$).
...
stability, G4 prospective $R^2 = 0.6946$ above the best baseline (Ridge
